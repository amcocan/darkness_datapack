...
tellraw @a [{"text":"| ", "color":"#ff003c"}, {"text":"Author: ", "color":"#868e96"}, {"text":"amcocan", "clickEvent":{"action":"open_url", "value":"https://github.com/amcocan"}, "hoverEvent":{"action":"show_text", "contents":{"text":"Github","color":"#ff003c"}}, "color":"#ff003c"}]
# Loading Modules Section Header
tellraw @a[team=!no_alerts] [{"text":"\n", "color":"#ff003c"}, {"text":"Modules Loaded", "color":"#ff003c", "bold":true}, {"text":"\n", "color":"#ff003c"}]
...
execute as @a[scores={death_cords=1..}] run data get entity @s LastDeathLocation
# Play a sound so that the player knows it ran.
execute as @e[type=minecraft:player] run playsound minecraft:block.creaking_heart.hit master @s ~ ~ ~ 0.5 0 0.5

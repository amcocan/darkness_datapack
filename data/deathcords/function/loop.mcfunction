...
execute as @a[scores={death_cords=1..}] run /tellraw @s [{"text":"Dimension: ", "color":"blue"}, {"storage":"deathcords:cache", "nbt":"Cache.Dimension", "color":"gold"}, {"text":"X: ", "color":"blue"}, {"storage":"deathcords:cache", "nbt":"Cache.Pos0", "color":"light_purple"}, {"text":"Y: ", "color":"blue"}, {"storage":"deathcords:cache", "nbt":"Cache.Pos1", "color":"light_purple"}, {"text":"Z: ", "color":"blue"}, {"storage":"deathcords:cache", "nbt":"Cache.Pos2", "color":"light_purple"}]

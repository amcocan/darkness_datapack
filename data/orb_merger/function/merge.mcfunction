...
# Tag all nearby (within 5 blocks), unmerged XP orbs as 'close_xp_orb'
execute at @s run tag @e[type=minecraft:experience_orb, tag=!main_xp_orb, distance=..5] add close_xp_orb

...
execute as @e[type=#invframe:invframe, nbt={Invisible: 1b}, limit=1, distance=..1.5] tag @s add invisible_entity
...
execute as @e[type=#invframe:invframe, nbt={Invisible: 0b}, limit=1, distance=..1.5] tag @s remove invisible_entity
# Reset and enable the trigger.

...
scoreboard players set @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{god_reaper:1}}}}] raycast_length 4
# Call raycast function.
execute as @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{god_reaper:1}}}}] run execute anchored eyes run function shearheads:raycast

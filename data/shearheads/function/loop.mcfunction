...
execute at @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{god_reaper:1}}}}] run execute as @e[tag=can_loot_head, distance=16..] at @s run data modify entity @s[tag=InField] Tags remove value "InField"

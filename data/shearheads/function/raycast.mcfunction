...
execute as @e[dx=0] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] run execute at @s[tag=!ray_caster] unless entity @s[type=!minecraft:allay] run particle dust{color:[1.0,0.0,0.24],scale:0.7} ~ ~1 ~ 0 0 0 0 0 force @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{god_reaper:1}}}}]
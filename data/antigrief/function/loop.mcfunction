...
execute at @a[tag=player] if entity @e[type=minecraft:creeper, distance=..4] run gamerule mobGriefing false
execute at @a[tag=player] if entity @e[type=minecraft:creeper, distance=5..] run gamerule mobGriefing true

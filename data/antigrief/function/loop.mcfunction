...
execute at @e[type=minecraft:creeper] unless entity @a[tag=player, sort=nearest, distance=5..] run gamerule mobGriefing false
execute at @e[type=minecraft:creeper] unless entity @a[tag=player, sort=nearest, distance=..4] run gamerule mobGriefing true

...
execute as @a[tag=player] at @s run execute as @e[type=minecraft:creeper, distance=..4] run gamerule mobGriefing false
execute as @a[tag=player] at @s run execute as @e[type=minecraft:creeper, distance=5..] run gamerule mobGriefing true

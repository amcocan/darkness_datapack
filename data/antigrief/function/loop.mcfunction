...
execute as @a[tag=creeper_target] unless entity @e[type=minecraft:creeper, distance=..10] run tag @s remove creeper_target
# Add creeper_target tag.
execute as @a[tag=player] unless entity @e[type=minecraft:creeper, distance=4..] run tag @s add creeper_target
